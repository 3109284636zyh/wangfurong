...
- **[部署指南](DEPLOYMENT.md)** - 完整的生产部署教程
- **[API文档](API.md)** - 所有接口的详细说明
- **[改进报告](IMPROVEMENTS.md)** - 最新优化内容
- **[架构文档](CLAUDE.md)** - 系统架构说明
...
### ⚡ 性能优化
- ✅ 数据库添加8个关键索引（查询性能提升30-50%）
- ✅ 优化会话记忆查询
- ✅ 优化违禁词检测查询
- ✅ 优化产品列表查询

### 🛠️ 开发体验
- ✅ 小程序支持多环境配置（dev/test/prod）
- ✅ 请求自动重试机制
- ✅ 小程序自动更新检查
- ✅ 统一的错误处理中间件
- ✅ 增强的健康检查接口
...
详细改进内容请查看 **[IMPROVEMENTS.md](IMPROVEMENTS.md)**
